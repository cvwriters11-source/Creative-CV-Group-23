...
const steps = [
  {
    ...
    copy: "You’ll be given the option to upload your old CV and tell us about your goals and aspirations such as a cover letter or LinkedIn profile.",
  },
  {
    n: "02",
...
function PackagesCatalog() {
  ...
  const total = useMemo(() => {
    ...
    return selectedPackage.price + extras;
  }, [selected, selectedAddons, selectedPackage.price]);
  ...
  return (
    ...
    <div className="mx-auto max-w-6xl px-5 py-16 lg:px-8">
      ...
      <section className="mt-16">
        ...
        <div className="mt-10">
          <PackagePricingGrid items={primaryCvPackages} selectedId={selected} onSelect={setSelected} />
        </div>
      </section>
    </div>
