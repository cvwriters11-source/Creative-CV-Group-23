...
import type { AdminWriter } from "@/lib/admin/types";

export function WriterManager({ writers }: { writers: AdminWriter[] }) {
  ...
  async function onRemove(writer: AdminWriter) {
  ...
  return (
    <div className="grid gap-6">
      <form onSubmit={onAdd} className="rounded-2xl bg-white p-5 shadow-[0_8px_24px_rgba(15,23,42,0.06)]">
        ...
        <p className="mt-1 text-sm text-slate-500">Name and email are required. Phone is optional.</p>
